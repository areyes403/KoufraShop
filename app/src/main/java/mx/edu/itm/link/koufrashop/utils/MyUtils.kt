package mx.edu.itm.link.koufrashop.utils
...
import mx.edu.itm.link.koufrashop.models.LocalDB
...
abstract class MyUtils {
    ...
    companion object {
        ...
        fun Context.dbSet(usuario: Usuario) {
            val dbManager = LocalDB(this,"my_eats", null, 1)
            dbManager.addUsr(usuario)
        }
